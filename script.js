...
const CONFIG = {
    ...
    whatsappAdicional: "5214491234567",
    ...
    textos: {
        ...
        cat2: { t: "PROMOCIONES", c: "Explora nuestra gama de servicios automotrices premium: Venta de vehículos nuevos de la línea Tiggo, planes de financiamiento a tu medida, pruebas de manejo a domicilio, taller mecánico especializado y venta de refacciones originales." },
        cat3: { t: "CLIENTES FELICES", c: "Nuestra prioridad es la excelencia en el servicio. Conductores y familias de Aguascalientes respaldan la calidad, el confort y el desempeño excepcional que solo la ingeniería avanzada de Chirey puede ofrecer." }
    },
    sucursales: {
        suc1: { nombre: "Asesor 1", wa: "5214491234567", maps: "https://maps.app.goo.gl/VmVobszjpiGihpZf9" },
        suc2: { nombre: "Asesor 2", wa: "5214491234567", maps: "https://maps.app.goo.gl/VmVobszjpiGihpZf9" },
        suc3: { nombre: "Asesor 3", wa: "5214491234567", maps: "https://maps.app.goo.gl/VmVobszjpiGihpZf9" },
        suc4: { nombre: "Asesor 4", wa: "5214491234567", maps: "https://maps.app.goo.gl/VmVobszjpiGihpZf9" },
        suc5: { nombre: "Asesor 5", wa: "5214491234567", maps: "https://maps.app.goo.gl/VmVobszjpiGihpZf9" },
        suc6: { nombre: "Asesor 6", wa: "5214491234567", maps: "https://maps.app.goo.gl/VmVobszjpiGihpZf9" }
    }
};
...
function renderGallery(cat) {
    ...
    if (cat === 'cat3') {
        ...
        videoContainer.innerHTML = `
            <a href="https://www.youtube.com/shorts/SJXvbNcHGvU" target="_blank" style="background: #000; color: #fff; padding: 10px 20px; border-radius: 8px; text-decoration: none; font-weight: 800; font-size: 0.7rem; border: 1px solid var(--brand-accent);">Opinión de nuestros clientes</a>
            <a href="https://www.youtube.com/shorts/HUlpbOsNOSg" target="_blank" style="background: #000; color: #fff; padding: 10px 20px; border-radius: 8px; text-decoration: none; font-weight: 800; font-size: 0.7rem; border: 1px solid var(--brand-accent);">El respaldo de tu Chirey</a>
        `;
